...
#define STRIDE ijg::TestGeom3::STRIDE
...
TestGeom3::TestGeom3(const Vec3f& pos, const Vec3f& rot, const Dim3f size, const std::vector< ProtoColor4f > col4s) :
...
void TestGeom3::setShader(const ProtoShader* shader) {
	this->shader = shader;
}
...
void TestGeom3::setDiffuseMap(const std::string& diffuseMapImage){
	createDiffuseMapTexture(diffuseMapImage);
}
void TestGeom3::setBumpMap(const std::string& bumpMapImage){
	createBumpMapTexture(bumpMapImage);
}
void TestGeom3::setReflectionMap(const std::string& reflectionMapImage){
}
void TestGeom3::setRefractionMap(const std::string& refractionMapImage){
}
void TestGeom3::setSpecularMap(const std::string& specularMapImage){
}

// begin internal texture implementation
void TestGeom3::createDiffuseMapTexture(const std::string& diffuseMapImage){// create default texture for diffuseMap
...
void TestGeom3::createBumpMapTexture(const std::string& bumpMapImage){
...
void TestGeom3::loadBumpMapTexture(const std::string& bumpMapImage){
...
void TestGeom3::createReflectionMapTexture(const std::string& reflectionMapImage){
}// loc 2
void TestGeom3::createRefractionMapTexture(const std::string& refractionMapImage){
}// loc 3
void TestGeom3::createSpecularMapTexture(const std::string& specularMapImage){
}// loc 4


void TestGeom3::calcFaces() {
	if (faces.size()>0){
		faces.clear();
	}
...
void TestGeom3::calcVertexNorms() {
...
void TestGeom3::textureOn(){
	//glEnable(GL_TEXTURE_2D);
	isTextureEnabled = true;
}

void TestGeom3::textureOff(){
	isTextureEnabled = false;

}


void TestGeom3::enableNormalMap(float depth){

}

void TestGeom3::disableNormalMap(){

}

// for STL output
std::vector<Tup4v> TestGeom3::getGeomData(){
	std::vector<Tup4v> vs;
...
void TestGeom3::display(RenderMode render, float pointSize) {
...
void TestGeom3::move(const Vec3f& v) {
	pos += v;
}

void TestGeom3::rotate(const Vec3f& r) {
	rot += r;
}

void TestGeom3::scale(const ProtoDimension3f& s) {
	size += s;
}

// transform VBO primitives using glBufferSubData
void TestGeom3::transform(const ProtoMatrix4f& mat4){
...
void TestGeom3::updateColorBuffer(){
	glBindBuffer(GL_ARRAY_BUFFER, vboID);
...
void TestGeom3::updateTextureBuffer(){
